...
for DOTFILE in "$DOTFILES_DIR"/system/.{function,function_*,path,env,alias,completion,grep,cmds}; do
  [ -f "$DOTFILE" ] && . "$DOTFILE"
done

# Initial target is Linux/Vagrant only
#
# if [ "$OS" = "OSX" ]; then
